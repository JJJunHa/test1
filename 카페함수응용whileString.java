...
//								
					...
					if(read.equals("o")) {
						...
						do {
							...
							if(read1.equals("C")) {
								...
								disPlayOrder(alName,alCount,alSum);
	...
	static void displayMenu(ArrayList<String>alMenue,ArrayList<Integer>alPricee) {
		for(int i=0; i<alMenue.size(); i++) {
			System.out.println((i+1)+" 번 메뉴 "+alMenue.get(i)+" : "+alPricee.get(i));
		}
		
	}
	static void disPlayOrder(ArrayList<String>N,ArrayList<Integer>C,ArrayList<Integer>S) {
		for(int i=0; i<N.size(); i++) {
			
			System.out.println("주문이름은 "+N.get(i));
			System.out.println("수량은 "+C.get(i));
			System.out.println("총합은 "+S.get(i));
			System.out.println("-----------------------");
